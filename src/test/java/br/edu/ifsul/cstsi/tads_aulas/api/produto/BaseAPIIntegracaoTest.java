...
import br.edu.ifsul.cstsi.tads_aulas.api.autenticacao.AutenticacaoService;
...
@SpringBootTest(classes = TadsAulasApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //indica que vai rodar o teste no container Spring Boot
