...
insert into usuarios(id,nome,sobrenome,email,senha, is_confirmado) values (1,'Admin','do Sistema','admin@email.com','$2a$10$5pFHlw2QefZZDA9lzP4mT.ue0FiamSV4jCb2SAKekvQbHrlap/73q', true);
insert into usuarios(id,nome,sobrenome,email,senha, is_confirmado) values (2,'Usuario','do Sistema','user@email.com','$2a$10$5pFHlw2QefZZDA9lzP4mT.ue0FiamSV4jCb2SAKekvQbHrlap/73q', true);
